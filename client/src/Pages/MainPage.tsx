    ...
    <div className="w-full relative">
      <div className="container mx-auto sm:px-6 lg:px-8">
        <div className="w-full h-auto mt-[100px] flex">
          ...
          <div
            className=" w-14 h-14 rounded-full bg-todayPink flex justify-center items-center absolute right-6 bottom-6 cursor-pointer transition-transform duration-500 hover:rotate-180"
